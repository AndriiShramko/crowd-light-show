...
(function () {
  ...
  var T = {
    en: {
      ...
      'price.kicker': 'Pricing', 'price.title': "Free to run yourself. Done-for-you if you'd rather not.",
      'price.lead': 'The app is free and open-source (Apache-2.0) — self-host it with no limits, or try the hosted demo. The paid tiers are an optional managed service: we plan, set up, operate and tune your show on the night. Final scope is confirmed on a quick call.',
      'price.free': 'Free', 'price.free.cap': 'self-host or demo', 'price.free.from': 'forever', 'price.free.badge': 'Start here', 'price.free.cta': 'Try it free →',
      'price.free.desc': 'Run the full app yourself with no limits — Docker, open source. Or try the hosted demo here. No per-person fee, no wristbands, no app for your crowd.',
      ...
      'wild.kicker': 'Seen in the wild', 'wild.title': 'Crowds already light up with their phones',
      'wild.lead': "It's a real moment people create — a wave of phone light across a stadium or a concert. Crowd Light Show turns it into a show you actually control: one operator drives every colour, flash and effect live, and the music plays in sync on every phone.",
    ...
    pl: {
      ...
      'price.kicker': 'Cennik', 'price.title': 'Darmowa, gdy uruchamiasz sam. Zrobione za Ciebie, jeśli wolisz.',
      'price.lead': 'Aplikacja jest darmowa i open-source (Apache-2.0) — uruchom ją sam bez limitów albo wypróbuj wersję demo. Płatne pakiety to opcjonalna usługa zarządzana: planujemy, konfigurujemy, prowadzimy i stroimy Twój pokaz na żywo. Ostateczny zakres ustalamy na krótkiej rozmowie.',
      'price.free': 'Za darmo', 'price.free.cap': 'self-host lub demo', 'price.free.from': 'na zawsze', 'price.free.badge': 'Zacznij tu', 'price.free.cta': 'Wypróbuj za darmo →',
      'price.free.desc': 'Uruchom całą aplikację sam, bez limitów — Docker, open source. Albo wypróbuj demo tutaj. Bez opłat za osobę, bez opasek, bez aplikacji dla widzów.',
      ...
      'wild.kicker': 'Z życia wzięte', 'wild.title': 'Tłumy już świecą telefonami',
      'wild.lead': 'To prawdziwy moment, który ludzie tworzą — fala światła z telefonów na stadionie czy koncercie. Crowd Light Show zamienia go w pokaz, którym naprawdę sterujesz: jeden operator prowadzi każdy kolor, błysk i efekt na żywo, a muzyka gra zsynchronizowana na każdym telefonie.',
    ...
    es: {
      ...
      'price.kicker': 'Precios', 'price.title': 'Gratis si la usas tú. Gestionada si lo prefieres.',
      'price.lead': 'La aplicación es gratuita y de código abierto (Apache-2.0) — instálala tú mismo sin límites, o prueba la demo alojada. Los planes de pago son un servicio gestionado opcional: planificamos, montamos, operamos y ajustamos tu espectáculo la misma noche. El alcance final se confirma en una llamada breve.',
      'price.free': 'Gratis', 'price.free.cap': 'self-host o demo', 'price.free.from': 'para siempre', 'price.free.badge': 'Empieza aquí', 'price.free.cta': 'Pruébala gratis →',
      'price.free.desc': 'Ejecuta la app completa tú mismo sin límites — Docker, código abierto. O prueba la demo aquí. Sin coste por persona, sin pulseras, sin app para tu público.',
      ...
      'wild.kicker': 'Visto en la vida real', 'wild.title': 'La gente ya se ilumina con sus teléfonos',
      'wild.lead': 'Es un momento real que la gente crea — una ola de luz de teléfonos por todo un estadio o un concierto. Crowd Light Show lo convierte en un espectáculo que de verdad controlas: un operador dirige cada color, destello y efecto en vivo, y la música suena sincronizada en cada teléfono.',
    ...
    fr: {
      ...
      'price.kicker': 'Tarifs', 'price.title': 'Gratuit si vous la lancez vous-même. Clé en main sinon.',
      'price.lead': 'L’application est gratuite et open-source (Apache-2.0) — hébergez-la vous-même sans limites, ou essayez la démo en ligne. Les formules payantes sont un service géré optionnel : nous planifions, installons, pilotons et réglons votre spectacle le soir même. Le périmètre final est confirmé lors d’un court appel.',
      'price.free': 'Gratuit', 'price.free.cap': 'auto-hébergé ou démo', 'price.free.from': 'pour toujours', 'price.free.badge': 'Commencez ici', 'price.free.cta': 'Essayer gratuitement →',
      'price.free.desc': 'Lancez l’app complète vous-même, sans limites — Docker, open source. Ou essayez la démo ici. Sans coût par personne, sans bracelets, sans appli pour votre public.',
      ...
      'wild.kicker': 'Vu en vrai', 'wild.title': 'Les foules s’illuminent déjà avec leurs téléphones',
      'wild.lead': "C'est un vrai moment que les gens créent — une vague de lumière de téléphones dans tout un stade ou un concert. Crowd Light Show en fait un spectacle que vous contrôlez vraiment : un opérateur pilote chaque couleur, flash et effet en direct, et la musique joue en synchronisation sur chaque téléphone.",
  ...
  var C = {
    en: {
      ...
      'console.vj_pal_h': '🎨 Palette — play only with chosen colours', 'console.vj_pal_sub': "Restrict the whole show to a flag's or a brand's colours — everything snaps to the nearest one. Works with or without the manual controls.", 'console.vj_pal_custom': 'Or hex', 'console.vj_pal_apply': 'Use', 'console.vj_pal_off': 'Palette: OFF', 'console.vj_pal_on': '● Palette: ON', 'console.vj_pal_add': '＋ Add colour', 'console.vj_pal_use': 'Use these colours',
    ...
    pl: {
      ...
      'console.vj_pal_h': '🎨 Paleta — graj tylko wybranymi kolorami', 'console.vj_pal_sub': 'Ogranicz cały pokaz do kolorów flagi lub marki — wszystko przyciąga się do najbliższego. Działa z ręcznym sterowaniem lub bez.', 'console.vj_pal_custom': 'Lub hex', 'console.vj_pal_apply': 'Użyj', 'console.vj_pal_off': 'Paleta: WYŁ', 'console.vj_pal_on': '● Paleta: WŁ', 'console.vj_pal_add': '＋ Dodaj kolor', 'console.vj_pal_use': 'Użyj tych kolorów',
