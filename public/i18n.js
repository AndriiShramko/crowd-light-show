...
(function (global) {
  var DICT = {
    pl: {
      ...
      agree_btn: '✓ Rozumiem — chcę dołączyć', how_more: 'Jak to działa? Prywatność',
      join_h: 'Świetnie! Dotknij, by dołączyć 👇', join_tip: '🔆 Ustaw jasność na maksimum i trzymaj ekran w stronę sceny.',
      join: 'Dołącz — ekran', join_torch: '🔦 Dołącz z latarką — jaśniej',
    ...
    en: {
      ...
      agree_btn: '✓ I understand — let me in', how_more: 'How does it work? Privacy',
      join_h: 'Great! Tap to join 👇', join_tip: '🔆 Turn brightness to max and hold the screen toward the stage.',
      join: 'Join — screen', join_torch: '🔦 Join with flashlight — brighter',
